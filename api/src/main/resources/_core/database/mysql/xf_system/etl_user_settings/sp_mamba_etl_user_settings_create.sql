...
(
 ...
 flat_table_load_batch_size INT NOT NULL DEFAULT 100000 COMMENT 'Encounter-ID range batch size for flat table inserts. Tune to hardware: HDD~50000, SSD~200000, NVMe~500000'
